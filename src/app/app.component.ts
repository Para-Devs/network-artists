  ...
  template: `
      <div class="overflow-x-hidden">
          ...
          <section id="weare" data-aos="fade-left"
              ...
              <p data-aos="fade-left" class="mt-10 mr-10 ml-10 content-text">A 360o music consultancy group and talent
                  buying company that
                  belongs at the
          ...
          <section id="purpose" data-aos-anchor="#purpose" data-aos="fade-right"
              ...
              <div class="p-10 h-screen flex flex-col justify-center ">
                  <h1 data-aos="fade-left" class="title-left">OUR PURPOSE </h1>
                  <p class="mt-10 ml-10 content-text">The purpose behind our company is to
                      CONNECT DOTS AND COMBINE WORKFORCES to fulfil desires and the gap in the market.</p>

                  <p data-aos="fade-right" class="mt-5 mr-10 ml-10 content-text">
          ...
          <section id="bio" data-aos-anchor="#bio" data-aos="fade-up"
              ...
              <ul data-aos="fade-in" class="mt-10 mr-10 ml-16 content-text">
            ...
            <ul data-aos="fade-in" class="mt-10 mr-10 ml-16 content-text">
              <li class="mt-5">Globally touring DJ and 1st Austrian live act signed to Sony. - Partnered ID&T’s Merchandise &
                Ticketing operation
                in Austria.
              </li>
              ...
              <li class="mt-5">Introduced brands such as Timewarp, Creamfields, Mayday, Loveparade and more into new markets. -
                Former music consultant for Coca Cola and Monster
                Energy group.
              </li>
              <li class="mt-5">Previous head of music for Burn Energy active in 122 countries and head mentor for Burn Residency. -
                General consultant Sekoya Management Group and music advisor for Soho Garden Developments in UAE and
                across the GCC area.
              </li>
            </ul>
          </section>
          <section id="service" data-aos-anchor="#service" data-aos="fade-down"
                   class="p-10 min-h-screen flex flex-col drop-shadow-2xl items-center bg-[rgba(1,14,51,0.8)] text-white justify-center">
              <h1 data-aos="fade-up" class="title-right-6">Service</h1>

              <p data-aos="fade-in" class="mt-10 mr-10 ml-10 content-text">
          ...
          <section id="consultancy" data-aos="fade-left"
              ...
              <p data-aos="fade-left" class="mt-10 mr-10 ml-10 content-text">We work with our partners to develop
              ...
              <ul class="mt-10 mr-10 ml-16 content-text">
          ...
          <section id="talentbuying" data-aos="fade-left"
                   class="p-10 min-h-screen flex flex-col drop-shadow-2xl items-center bg-[rgba(11,40,73,0.95)] text-white justify-center">

              <h1 data-aos="fade-right" class="title-right">TALENT BUYING</h1>
              <p data-aos="fade-left" class="mt-10 mr-10 ml-10 content-text">Our database includes direct contacts to all talent within the world of electronic music and beyond. We are privileged to have personal and strong relationships with many artists, managers and agents, which helps us ensure a smooth and fast operation. The rise and growth in electronic music has brought many new possibilities, from festivals, to collaborations and it has opened doors in the ever-evolving genres of pop, rock and urban.</p>

          </section>


        <section id="events" data-aos-anchor="#events" data-aos="fade-in"
                 class=" flex  min-h-screen flex-col drop-shadow-2xl items-center justify-center bg-white text-[rgba(1,14,51,0.8)] p-20">
          <h1 data-aos="fade-right" class="title-left">EVENTS</h1>
          <p data-aos="fade-left" class="mt-10 mr-10 ml-10 content-text">The NETWORK ARTISTS are your sidekick to custom event management, from conceptualization to coordination, to implementation.
            We play a competitive role in the perimeters of public and private events, whether it is discreet for your close circle, or you are a corporation looking to connect brands and talent for universal exposure. There’s always an event master plan that encompasses the venue, logistics and entertainment to ensure that everyone in your world holds an everlasting imprint of the experience.</p>
        </section>
