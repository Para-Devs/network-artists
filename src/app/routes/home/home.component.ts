...
\t\t\tC368.2,275.4,368.4,276,368.6,276.6z"/>
          <circle routerLink="/method" cx="17" cy="381" r="10" fill="white" class=" myCircle myCircleLeft">
    <animate attributeName="r" from="8" to="20" dur="1.5s" begin="0s" repeatCount="indefinite"/>
            <animate attributeName="opacity" from="1" to="0" dur="1.5s" begin="0s" repeatCount="indefinite"/>
  </circle>
          <text x="0" y="400" font-size="10" fill="white" text-anchor="start" alignment-baseline="middle">METHOD
  </text>
          <circle routerLink="/service" cx="186" cy="140" r="10" fill="white" class="myCircle myCircleTop">
    <animate attributeName="r" from="8" to="20" dur="1.5s" begin="0s" repeatCount="indefinite"/>
            <animate attributeName="opacity" from="1" to="0" dur="1.5s" begin="0s" repeatCount="indefinite"/>
  </circle>
          <text x="360" y="400" font-size="10" fill="white" text-anchor="middle" alignment-baseline="middle">SERVICE
  </text>
          <circle routerLink="/connect" cx="359" cy="380" r="10" fill="white" class="myCircle myCircleRight">
    <animate attributeName="r" from="8" to="20" dur="1.5s" begin="0s" repeatCount="indefinite"/>
            <animate attributeName="opacity" from="1" to="0" dur="1.5s" begin="0s" repeatCount="indefinite"/>
  </circle>
</svg>
